...
export function Presentations() {
  return (
    <div className="relative z-10 flex flex-1 items-end md:items-center">
      <div className="relative mx-auto w-full max-w-7xl h-[50dvh] flex md:mt-60">
        {/* Panel — ocupa el 46% derecho en desktop, full en mobile */}
        <div
          className={cn(
            "relative flex items-center justify-center h-full md:w-[40%]",
            slideIn.left,
            "duration-1000",
          )}
        >
          <Image
            ...
            height={300}
            className={cn(
              "object-cover hidden md:block rounded-2xl shadow-lg shadow-background",
            )}
          />
        </div>
...
function LeftPresentation() {
  ...
  return (
    <div className={cn("flex flex-col md:ml-auto md:w-[30%] ml-10 h-full")}>
      {/* Línea decorativa */}
      <span
      ...
      <p
        className={cn(
          "mb-9 max-w-[320px] text-[13px] font-light leading-[1.85] text-foreground/65",
          slideIn.right,
          "duration-2000",
        )}
      >
      ...
      >
        ...
        <Link
          href={ctaPrimaryHref}
          className={cn(
            "group inline-flex items-center gap-2.5 px-7 py-[13px]",
